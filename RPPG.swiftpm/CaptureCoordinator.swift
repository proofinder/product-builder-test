// Generated by tools/make_swiftpm.py from App/RPPG/Capture/CaptureCoordinator.swift — do not edit here.
...
final class CaptureCoordinator: @unchecked Sendable {
    ...
    struct Settings {
        ...
        var landmarkPreset: FaceTracker.LandmarkPreset = .rigid
    }
    ...
    func start() async throws {
        ...
        visionQueue.async { self.tracker.setPreset(settings.landmarkPreset) }
    ...
    /// Changes the landmark set the similarity fit runs on. Re-anchors, and clears the
    /// measurement window so the jitter figure describes the new preset only.
    func setLandmarkPreset(_ preset: FaceTracker.LandmarkPreset) {
        settings.landmarkPreset = preset
        visionQueue.async { self.tracker.setPreset(preset) }
        resetStatistics()
    }
